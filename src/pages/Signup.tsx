    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-gray-900 mb-1">Join Mesh</h1>
          ...
          <CardContent className="space-y-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`pl-10 h-10 bg-white/50 border-gray-200 focus:border-gray-300 ${errors.username ? "border-red-500 focus:border-red-500" : ""
                      }`}
                    required
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className={`pl-10 h-10 bg-white/50 border-gray-200 focus:border-gray-300 ${errors.fullName ? "border-red-500 focus:border-red-500" : ""
                      }`}
                    required
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className={`pl-10 h-10 bg-white/50 border-gray-200 focus:border-gray-300 ${errors.email ? "border-red-500 focus:border-red-500" : ""
                      }`}
                    required
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className={`pl-10 pr-10 h-10 bg-white/50 border-gray-200 focus:border-gray-300 ${errors.password ? "border-red-500 focus:border-red-500" : ""
                      }`}
                    required
                  />
                  <button
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className={`pl-10 pr-10 h-10 bg-white/50 border-gray-200 focus:border-gray-300 ${errors.confirmPassword ? "border-red-500 focus:border-red-500" : ""
                      }`}
                    required
                  />
                  <button
              ...
              <div className="flex items-start space-x-2">
                <input
                  type="checkbox"
                  id="terms"
                  className="mt-1 rounded border-gray-300 text-gray-700 focus:ring-gray-400 focus:ring-offset-0"
                  required
                />
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center">
                <span className="px-2 text-xs text-gray-500 bg-white/70">Or continue with</span>
              </div>
            </div>
